...
class DBWNode(object):
    def __init__(self):
        ...
        decel_limit = rospy.get_param('~decel_limit', -15.) # needs to be strong since we hace a short trajectory
        ...
        min_speed = 0.1     # m/s ? Why is it even required? M:
        max_speed = 20      # m/s ? What's the maximum allowed speed here? # Actually We are not using it. M:
